...
INSERT INTO movies (id, title, fk_genre, director, yearofrelease, description, duration, stars, iswatched, fk_user)
VALUES (2, 'The Grand Budapest Hotel', 1, 'Wes Anderson', 2014, 'A quirky adventure in a luxurious European hotel.', 99, 4, false, 1);
...
INSERT INTO movies (id, title, fk_genre, director, yearofrelease, description, duration, stars, iswatched,fk_user)
VALUES (5, 'The Martian', 1, 'Ridley Scott', 2015, 'An astronaut stranded on Mars fights for survival.', 144, 4, false, 1);
